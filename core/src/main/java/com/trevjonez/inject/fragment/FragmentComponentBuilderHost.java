...
public interface FragmentComponentBuilderHost {
    <F extends Fragment, B extends FragmentComponentBuilder<F, ? extends PlainComponent<F>>> B getFragmentComponentBuilder(Class<F> fragmentKey, Class<B> builderType);
}
